...
to setup
  ...
  initialize-hormones
  new-muscle-fibers
  set days-between-workouts ((days-between-workouts - (days-between-workouts / 100 * deviation-measure))/ 100 * deviation-probability + (days-between-workouts + (days-between-workouts / 100 * deviation-measure))/ 100 * deviation-probability )
...
to lift-weights
  ...
  ask muscle-fibers [
    if( random-float 1.0 < ((intensity - (intensity / 100 * deviation-measure))/ 100 * deviation-probability
      + (intensity + (intensity / 100 * deviation-measure))/ 100 * deviation-probability )) [
...
to quality-food
  ...
  ask patches [
    set catabolic-hormone catabolic-hormone - 0.5 * (log catabolic-hormone 10) * quality-of-food
    set anabolic-hormone anabolic-hormone - 0.48 * (log anabolic-hormone 10) * quality-of-food
  ]
end
...
to genetic
  ...
  ask patches [
    set catabolic-hormone catabolic-hormone - 0.5 * (log catabolic-hormone 10) * ((genetic-predisposition - (genetic-predisposition / 100 * deviation-measure))/ 100 * deviation-probability + (hours-of-sleep + (genetic-predisposition / 100 * deviation-measure))/ 100 * deviation-probability )
    set anabolic-hormone  anabolic-hormone - 0.48 * (log anabolic-hormone 10) * ((genetic-predisposition - (genetic-predisposition / 100 * deviation-measure))/ 100 * deviation-probability + (hours-of-sleep + (genetic-predisposition / 100 * deviation-measure)) / 100 * deviation-probability)
  ]
end
...
to sleep
  ;; simulate hormonal effect of sleeping
  ask patches [
    set catabolic-hormone catabolic-hormone - 0.5 * (log catabolic-hormone 10) * ((hours-of-sleep - (hours-of-sleep / 100 * deviation-measure))/ 100 * deviation-probability + (hours-of-sleep + (hours-of-sleep / 100 * deviation-measure))/ 100 * deviation-probability )
    set anabolic-hormone  anabolic-hormone - 0.48 * (log anabolic-hormone 10) * ((hours-of-sleep - (hours-of-sleep / 100 * deviation-measure))/ 100 * deviation-probability + (hours-of-sleep + (hours-of-sleep / 100 * deviation-measure)) / 100 * deviation-probability)
  ]
end
