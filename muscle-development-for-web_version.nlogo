...
to genetic
  ...
  ask patches [
    set catabolic-hormone catabolic-hormone - 0.3 * (log catabolic-hormone 10) * genetic-predisposition
    set anabolic-hormone  anabolic-hormone - 0.4 * (log catabolic-hormone 10)* genetic-predisposition
  ]
end
